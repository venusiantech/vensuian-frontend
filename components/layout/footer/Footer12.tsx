...
export default function Footer12() {
	return (
		<>
			...
			<footer className="footer-style-9">
									...
									<form action="#">
										...
										<button>
											<svg width={30} height={12} viewBox="0 0 30 12" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M28 6H1" stroke="#F6F6F6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
												<path d="M24 11C24 11 29 7.31756 29 5.99996C29 4.68237 24 1 24 1" stroke="#F6F6F6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
											</svg>
										</button>
									</form>
								</div>
							...
							<div className="footer-bottom">
								<div className="row paragraph-base">
									<div className="col-sm-6">
										<div className="paragraph-rubik-m color-white">Copyright © Vatech {new Date().getFullYear()} . Alright Reserved.</div>
									</div>
									<div className="col-sm-6 d-flex justify-content-center justify-content-lg-end">
										<Link href="#" className="paragraph-rubik-m color-white">Terms &amp; Conditions / Privacy &amp; Policy</Link>
									</div>
								</div>
							</div>
						</div>
