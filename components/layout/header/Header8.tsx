...
export default function Header8({ scroll, isMobileMenu, handleMobileMenu, handleSearch, isSearch }: any) {
	return (
		<>

			<div>
				<section className="top-bar position-relative z-4 d-none d-lg-block top-bar-style-8 ">
				...
				{/* Navbar */}
				<header className="header-style-8 header-style-4">
					<nav className={`navbar navbar-expand-lg navbar-light w-100 ${scroll ? 'navbar-stick position-fixed top-0' : ''}`}>
						<div className="container px-3">
							<Link className="navbar-brand pe-4" href="/"><img src="/assets/imgs/template/logo6.svg" alt="" /></Link>
							...
							<div className="d-flex align-items-center">
								...
								<Link href="#" className="btn btn-linear-02 d-none d-lg-inline-block">
									Get a quote
								</Link>
							</div>
						</div>
