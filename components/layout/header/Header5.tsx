...
export default function Header5({ scroll, isMobileMenu, handleMobileMenu, handleSearch, isSearch }: any) {
	return (
		<>

			<header className="header-style-3 header-style-4 header-style-5">
				<nav className={`navbar navbar-expand-lg navbar-light w-100 ${scroll ? 'navbar-stick position-fixed top-0' : ''}`}>
					<div className="container px-3">
						<div className="header-navar">
							<Link className="navbar-brand pe-4" href="/"><img src="/assets/imgs/template/logo4.svg" alt="" /></Link>
