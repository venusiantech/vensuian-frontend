...
export default function Header7({ scroll, isMobileMenu, handleMobileMenu, handleSearch, isSearch }: any) {
	return (
		<>

			<header className="header-style-7">
				<nav className={`navbar navbar-expand-lg navbar-light w-100 ${scroll ? 'navbar-stick position-fixed top-0' : ''}`}>
					<div className="container px-3">
						...
						<div className="d-flex align-items-center">
							...
							<Link href="#" className="btn btn-primary-1000-md d-none d-lg-inline-block">
								Get a quote
