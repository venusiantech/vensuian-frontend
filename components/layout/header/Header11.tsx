				...
				<nav className={`navbar navbar-expand-lg navbar-light w-100 ${scroll ? 'navbar-stick position-fixed top-0' : ''}`}>
					<div className="container-fluid">
						...
						<ul className="navbar-nav gap-1 align-items-lg-center m-auto">
							...
							<li className="nav-item">
								<Link className="nav-link fw-medium" href="/about-us-4" role="button" data-bs-toggle="dropdown" aria-expanded="false">About</Link>
								<ul className="dropdown-menu">
							...
							<li className="nav-item ">
								<Link className="nav-link fw-medium" href="/services-4" role="button" data-bs-toggle="dropdown" aria-expanded="false">Services</Link>
								<ul className="dropdown-menu">
							...
							<li className="nav-item ">
								<Link className="nav-link fw-medium" href="/contact" role="button" data-bs-toggle="dropdown" aria-expanded="false">Contact</Link>
