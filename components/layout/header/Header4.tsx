...
export default function Header4({ scroll, isMobileMenu, handleMobileMenu, handleSearch, isSearch }: any) {
	return (
		<>

			<header className="header-style-3 header-style-4">
				<nav className={`navbar navbar-expand-lg navbar-light w-100 ${scroll ? 'navbar-stick position-fixed top-0' : ''}`}>
					<div className="container container-topbar d-none d-lg-block">
						<div className="header-topbar">
							<div className="topbar-left">
								<span className="location me-5"><strong>Location</strong> 62, Business Str Hobert, AU</span>
								<span className="email"><strong>email</strong> info@acorn.com</span>
							</div>
							<div className="topbar-right">
								<span className="phone"><strong>Phone</strong> +98 909807</span>
							</div>
						</div>
					</div>
