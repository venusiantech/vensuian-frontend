...
export default function Header16({ scroll, isMobileMenu, handleMobileMenu, handleSearch, isSearch }: any) {
	return (
		<>

			<div>
				<section className="top-bar position-relative z-4 d-none d-lg-block top-bar-16 ">
				...
				{/* Navbar */}
				<header className="header-style-16">
					<nav className={`navbar navbar-expand-lg navbar-light w-100 ${scroll ? 'navbar-stick position-fixed top-0' : ''}`}>
						<div className="container px-3">
							...
							<ul className="navbar-nav gap-1 align-items-lg-center m-auto me-4">
